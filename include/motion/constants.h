...
#define MOTOR_SPEED_TRANSLATION                     14000   // Base speed for when we are trying to dock
...
#define ROTATE_INITIAL_DELAY                        2000    // delay between rotation task beginning and checking for tape (ms)               
