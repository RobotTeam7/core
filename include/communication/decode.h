 ...
 */
typedef enum { NONE = 0x00, GOTO = 0x01, DO_SPIN = 0x02, COMPLETED = 0x03, ABORT = 0x04, OCCUPIED = 0x05, ACCEPTED = 0x06, READY = 0x07, COUNTER_DOCK = 0x08, TAPE_RETURN = 0x09, FOLLOW_WALL_TO = 0x10 } CommandMessage_t;   
