...
<<<<<<< HEAD
        ...
        log_status("Motion ready! Going to Station 2!");
        ...
        actuate_stepper_motor(stepper_motor, DOWN, 6000);
        ...
        claw_servo.write(SERVO_CLAW_OPEN + 30);
        delay(2000);
        ...
        draw_bridge_servo.write(SERVO_DRAW_BRIDGE_DOWN + 20);
